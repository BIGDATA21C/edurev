...
@NgModule({
  ...
  providers: [DataServicesService, AuthenticationService, AuthGuardService,
     ProjectsopPipe,FoldersearchPipe,PrelimsfilterPipe,OptionalsPipe,GeneralstudiesPipe,EssayfilterPipe],
